...
RSpec.describe "open_positions/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit open_position form" do
    render

    assert_select "form[action=?][method=?]", open_position_path(@open_position), "post" do
